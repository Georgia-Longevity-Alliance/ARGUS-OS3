...
ARGUS-OS3 строит **прогениторные карты** на основе spindle pedigrees центриолей (OS1) и доказательства конвергенции (OS2).

> **🔴 Зависит от успеха OS2.** Без доказательства что spindle pedigree → судьба, карты строить не из чего.
...
А ГРАФ (узлы = генетические сети, рёбра = spindle pedigree)
```

| Элемент графа | Что это |
|--------------|---------|
| **Узел** | Паттерн генной экспрессии (генетическая сеть) |
| **Ребро** | Spindle pedigreeия центриоли (∥/⟂ или θ) |
| **Конвергенция** | Разные spindle pedigree → один узел |
...
| Данные | Источник |
|--------|----------|
| Spindle pedigreeии центриолей (∥/⟂, θ) | ARGUS-OS1 |
...
| Шаг | Действие |
|:---:|----------|
| 1 | Получить spindle pedigree + судьбы от OS1 |
...
| 2 | ARGUS-OS1/CONCEPT.md | Spindle pedigreeии центриолей |
